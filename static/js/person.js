(function () {
  ...
  function showPerson(container, data) {
    document.getElementById("person-name").textContent = data.name || "Person";
    document.getElementById("person-role").textContent = data.role_or_title || "";
    document.getElementById("person-bio").textContent = data.bio || "";
    var html = "";
